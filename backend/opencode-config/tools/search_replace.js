...
1. STRING FORMAT: old_string and new_string must be plain strings. Use actual newline characters for multi-line content (do NOT use literal backslash-n). Match the file's exact whitespace and indentation.

2. UNIQUENESS: The old_string MUST uniquely identify the specific instance you want to change. This means:
   - Include AT LEAST 3-5 lines of context BEFORE the change point
   - Include AT LEAST 3-5 lines of context AFTER the change point
   - Include all whitespace, indentation, and surrounding code exactly as it appears in the file

3. SINGLE INSTANCE: This tool can only change ONE instance at a time. If you need to change multiple instances:
