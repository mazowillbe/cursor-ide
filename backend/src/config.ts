...
export const config = {
  ...
  /** Default model for opencode run. Prefer Zen when OPENCODE_ZEN_API_KEY is set; else Gemini when GEMINI_API_KEY is set; else Zen (requires opencode auth login). */
